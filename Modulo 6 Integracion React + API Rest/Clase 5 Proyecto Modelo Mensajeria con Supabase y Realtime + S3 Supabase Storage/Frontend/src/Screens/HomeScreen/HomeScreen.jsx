                    ...
                    <ul className="workspace-list">
                        {
                            ...
                            ? workspace_list.data.workspaces.map(workspace => (
                                <Link to={`/workspace/${workspace.workspace_id}`} key={workspace.workspace_id} style={{textDecoration: 'none', color: 'inherit'}}>
                                    <li className="workspace-item">
                                        <div className="workspace-icon">
                                            {workspace.workspace_image ? (
                                                <img src={workspace.workspace_image} alt="Icon" className="workspace-icon-img" />
                                            ) : (
                    ...
                    <div className="welcome-section">
                        ...
                        {workspace_list.data.workspaces && workspace_list.data.workspaces.length > 0 
                            ? <div className="workspaces-grid">
                                {workspace_list.data.workspaces.map(workspace => (
                                    <Link to={`/workspace/${workspace.workspace_id}`} key={workspace.workspace_id} style={{textDecoration: 'none'}}>
